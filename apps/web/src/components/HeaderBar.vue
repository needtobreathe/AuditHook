...
<template>
  <header class="h-14 border-b border-slate-800/80 bg-slate-950 px-4 flex items-center justify-between z-20 select-none">
    ...
    <div class="flex items-center space-x-3">
      <div class="flex items-center bg-slate-900 border border-slate-800 rounded px-2.5 py-1 text-xs">
      ...
      <div class="flex items-center space-x-2 px-2.5 py-1 rounded bg-slate-900 border border-slate-800 text-xs">
      ...
      <div class="text-xs text-slate-500 font-mono pl-1">
